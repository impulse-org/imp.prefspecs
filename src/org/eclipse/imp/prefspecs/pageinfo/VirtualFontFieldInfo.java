...
public class VirtualFontFieldInfo extends VirtualFieldInfo {
	...
	public VirtualFontFieldInfo(PreferencesPageInfo parentPage, String name) {
		super(parentPage, name);
	}
	
	public VirtualFontFieldInfo(PreferencesPageInfo parentPage, String name, String defName, int defHeight, int defStyle) {
