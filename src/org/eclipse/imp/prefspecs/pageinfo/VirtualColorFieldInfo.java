...
public class VirtualColorFieldInfo extends VirtualFieldInfo {
	...
	public VirtualColorFieldInfo(PreferencesPageInfo parentPage, String name) {
		super(parentPage, name);
	}
	
	public VirtualColorFieldInfo(PreferencesPageInfo parentPage, String name, String defColor) {
