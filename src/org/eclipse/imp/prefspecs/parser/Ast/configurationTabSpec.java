...
/**
 *<b>
 *<li>Rule 35:  configurationTabSpec ::= CONFIGURATION$ inout {$ generalSpecs }$
 *</b>
 */
public class configurationTabSpec extends ASTNode implements IconfigurationTabSpec
{
    ...
    public configurationTabSpec(IToken leftIToken, IToken rightIToken,
                                Iinout _inout,
