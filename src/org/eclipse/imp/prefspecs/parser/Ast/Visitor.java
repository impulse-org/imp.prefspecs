...
public interface Visitor extends IAstVisitor
{
    ...
    boolean visit(tabSpecs n);
    void endVisit(tabSpecs n);
    ...
    boolean visit(generalSpecs n);
    void endVisit(generalSpecs n);
    ...
    boolean visit(booleanSpecificSpec n);
    void endVisit(booleanSpecificSpec n);
    ...
    boolean visit(comboSpecificSpec n);
    void endVisit(comboSpecificSpec n);

    boolean visit(comboCustomSpec n);
    void endVisit(comboCustomSpec n);

    boolean visit(comboDefValueSpec n);
    void endVisit(comboDefValueSpec n);

    boolean visit(radioSpecificSpec n);
    void endVisit(radioSpecificSpec n);

    boolean visit(radioCustomSpec n);
    void endVisit(radioCustomSpec n);
    ...
    boolean visit(intSpecificSpec n);
    void endVisit(intSpecificSpec n);

    boolean visit(intCustomSpec n);
    void endVisit(intCustomSpec n);
    ...
    boolean visit(doubleSpecificSpec n);
    void endVisit(doubleSpecificSpec n);
    ...
    boolean visit(stringSpecificSpec n);
    void endVisit(stringSpecificSpec n);

    boolean visit(stringCustomSpec n);
    void endVisit(stringCustomSpec n);
