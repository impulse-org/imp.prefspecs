...
public class fileFieldSpec extends ASTNode implements IfileFieldSpec
{
    ...
    private fileFieldPropertySpecs _fileFieldPropertySpecs;
    private optConditionalSpec _optConditionalSpec;

    public identifier getidentifier() { return _identifier; }
    /**
     * The value returned by <b>getfileFieldPropertySpecs</b> may be <b>null</b>
     */
    public fileFieldPropertySpecs getfileFieldPropertySpecs() { return _fileFieldPropertySpecs; }
    /**
    ...
    public fileFieldSpec(IToken leftIToken, IToken rightIToken,
                         identifier _identifier,
                         fileFieldPropertySpecs _fileFieldPropertySpecs,
                         optConditionalSpec _optConditionalSpec)
    {
        ...
        this._fileFieldPropertySpecs = _fileFieldPropertySpecs;
        if (_fileFieldPropertySpecs != null) ((ASTNode) _fileFieldPropertySpecs).setParent(this);
    ...
    public java.util.ArrayList getAllChildren()
    {
        ...
        list.add(_fileFieldPropertySpecs);
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof fileFieldSpec)) return false;
        if (! super.equals(o)) return false;
        fileFieldSpec other = (fileFieldSpec) o;
        if (! _identifier.equals(other._identifier)) return false;
        if (_fileFieldPropertySpecs == null)
            if (other._fileFieldPropertySpecs != null) return false;
            else; // continue
        else if (! _fileFieldPropertySpecs.equals(other._fileFieldPropertySpecs)) return false;
    ...
    public int hashCode()
    {
        ...
        hash = hash * 31 + (_fileFieldPropertySpecs == null ? 0 : _fileFieldPropertySpecs.hashCode());
    ...
    public void enter(Visitor v)
    {
        ...
        if (checkChildren)
        {
            ...
            if (_fileFieldPropertySpecs != null) _fileFieldPropertySpecs.accept(v);
