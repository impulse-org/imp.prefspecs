...
/**
 *<em>
 *<li>Rule 108:  isRemovableSpec ::= $Empty
 *</em>
 *<p>
 *<b>
 *<li>Rule 109:  isRemovableSpec ::= ISREMOVABLE$ booleanValue ;$
 *</b>
 */
public class isRemovableSpec extends ASTNode implements IisRemovableSpec
{
    ...
    public isRemovableSpec(IToken leftIToken, IToken rightIToken,
    ...
    public boolean equals(Object o)
    {
        ...
        if (! (o instanceof isRemovableSpec)) return false;
        if (! super.equals(o)) return false;
        isRemovableSpec other = (isRemovableSpec) o;
